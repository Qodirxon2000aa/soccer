      ...
      <ul className="menu flex flex-col gap-[24px]">
        ...
        >
          <li>
            ...
            <p className="text-gray">Uchrashuvlar</p>
          </li>
        </ScrollLink>
        <ScrollLink
          onClick={() => setIsMenuOpen(false)}
        ...
        >
          <li>
            ...
            <p className="text-gray">Jadval</p>
          </li>
        </ScrollLink>
        <ScrollLink
          onClick={() => setIsMenuOpen(false)}
        ...
        >
          <li>
            ...
            <p className="text-gray">Tanlangan Kulublar</p>
          </li>
        </ScrollLink>
        <ScrollLink
          onClick={() => setIsMenuOpen(false)}
        ...
        >
          <li>
            ...
            <p className="text-gray">Yangiliklar</p>
          </li>
        </ScrollLink>
      </ul>

      <h1 className="mt-[40px] mb-[20px] text-gray text-sm">Tanlangan Kulublar</h1>
